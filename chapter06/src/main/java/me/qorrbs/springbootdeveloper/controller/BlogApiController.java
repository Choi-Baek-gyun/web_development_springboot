...
import me.qorrbs.springbootdeveloper.dto.ArticleResponse;
import me.qorrbs.springbootdeveloper.service.BlogService;
...
public class BlogApiController {
    ...
    /*
        ...
        내일은 반복작업을 줄여줄 테스트 코드들을 작성하겠습니다.
            ...
            test 폴더에 AddApiControllerTest,java를 만들기 위한 방법
            파일 내에 들어와서 publick class BlogApiController
     */
    ...
    // URL 경로에서 값을 추출
    public ResponseEntity<ArticleResponse> findArticle(@PathVariable long id) { // URL에서 {id}에 해당하는 값이 id로 들어감
        Article article = blogService.findById(id);

        return ResponseEntity.ok()
                .body(new ArticleResponse(article));
        // 위 ResponseEntity와 비교해보시길 바랍니다.
    }
    /*
    ...
    /*
        ...
        다 확인 끝났으면 BlogApiControllerTest.java가서 테스트 형태의 메서드 생성
