...
import me.qorrbs.springbootdeveloper.service.UserService;
...
public class UserApiController {
    ...
    /*
        회원가입 절차가 완료된 이후에 로그인 페이지로 이동하기 위해 "redirect:" 접두사를 붙였습니다.
        이렇게 하면 회원가입 절차가 끝났을 때 강제로 /login url에 해당하는 화면으로 이동합니다.
