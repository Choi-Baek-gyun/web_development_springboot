package me.qorrbs.springbootdeveloper.config;

import lombok.Builder;
import lombok.RequiredArgsConstructor;
import me.qorrbs.springbootdeveloper.service.UserDetailService;
...
/*
    ...
    5. 로그아웃 설정
        logoutSuccessUrl() : 로그아웃이 완료 되었을 대 이동할 경로를 설정
        invalidHttpSesstion() : 로그아웃 이후에 세션을 삭제할지 여부를 설정 -> 저희는 true 설정

    6. csrf 설정을 비활성화 - CSRF 공격을 방지하기 위해서 사용하는 건데, 실습 좀 편하게 하려고 비활성화 해놨습니다.
        (정처기 필기에서 본 적 있음)
    ...
    회원 가입 구현
        서비스 메서드 작성할 겁니다. -> 사용자 정보를 담고 있는 객체를 만들 수 있도록 해야합니다.
