...
/*
    1. generateToken
        ...
        when : 토큰 제공자의 generateToken() 메서드를 호출 -> 토큰 새엇ㅇ
        then : jjjwt 라이브러리를 사용하여 토큰을 복호화
    ...
    2.
        ...
        2) validToken_invalidToken()
            given : jjwt 라이브러리를 사용, 토큰 생성. -> 1970년 1월 1일부터
    ...
    3. getAuthentication()
        ...
        then : 반환 받은 인증 객체의 유저 이름(username)을 가져와서 given절에서 초기화한
    ...
    4. getUserId()
        ...
        then : 반환받는 유저 ID가 given절에서 초기화한 1과 같은지를 확인.
 */